...
const ImageResult = () => {
  ...
  return (
    <div className="overflow-x-none bg-white   ">
      ...
      <div className="flex flex-row gulu items-stretch border-t border-t-gray-200 box-border   overflow-x-none lg:relative bg-white lg:flex-row md:flex-col sm:flex-col  ">
        <div className="flex flex-col items-center bg-[#1F2125] box-border h-full w-full  lg:relative overflow-y-hidden ">
          ...
          <div className="w-full observer h-[100vh] flex justify-center items-center bg-[#1F2125]   overflow-hidden ">
        ...
        <div className="flex flex-col flex-wrap items-center bg-white box-border  h-full  w-[50%] text-black overflow-x-none overflow-y-auto md:w-[100%] sm:w-[100%] break-words  mr-0  sm:flex-col xl:max-h-[100%] ">
          {arr.map((le, gi) => (
                  ...
                  >
                    ...
                    <div className="inline-flex  items-center  py-[4px] px-[2px] bg-[#FFFFFFE6]   rounded-full absolute top-4  left-4">
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        width="16"
                        className="my-[2px] ml-[6px] mr-[4px]"
                      >
                        <g>
